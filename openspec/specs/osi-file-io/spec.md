## Purpose
Handle importing and exporting OSI models in JSON and YAML formats, including format detection, error reporting, and round-trip fidelity of model content.
