## Purpose
Define the in-memory representation of OSI ontology documents, including concepts, ontology relationships, and ontology mappings, with round-trip fidelity distinct from semantic-model documents.
